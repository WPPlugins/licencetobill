...
class LicenceToBill {
   ...
   */
  function trial($key_user, $name_user=NULL, $lcid=NULL, $key_offer) {

	if ($key_offer != NULL)
		$this->free_key_offer = $key_offer;
	else
  ...
  function address($key_user, $company=NULL, $fullname=NULL, $address_line1=NULL, $address_line2=NULL, $zipcode=NULL, $city=NULL, $country=NULL, $country_iso2=NULL, $country_iso3=NULL, $vat_information=NULL) {
  	$post=array();
